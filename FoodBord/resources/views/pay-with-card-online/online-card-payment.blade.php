...
<body>
                                        ...
                                        <div class="order-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="cbx radio-wrapper no-edges">
                                                        <input type="radio" value="delivery" name="transfer" id="transfer" checked> <span class="checkmark"></span>
                                            ...
                                            <div class="row total-container">
                                                <div class="col-md-12 p-0">
                                                    ...
                                                    <input type="hidden" id="total" class="total format-price" name="total"  value="" data-parsley-errors-container="#totalError" data-parsley-empty-order=""  />
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="phone_number" class="form-control" name="phone_number" type="text" data-parsley-pattern="^\+{1}[0-9]+$" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="address" class="form-control" name="address" type="text" data-parsley-pattern="^[,.a-zA-Z0-9\s.]+$" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="message" class="form-control" name="message" type="text" data-parsley-pattern="^[a-zA-Z0-9\s.:,!?']+$" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row total-container">
    ...
    <script src="../js/stripe-func.js"></script>
